...
global conn, cursor
conn = sqlite3.connect('bus_bks.db')
c = conn.cursor()
c.execute(''' CREATE TABLE IF NOT EXISTS Bus999( pnr integer,Name Text, Gender Text, Age real, Bustype Text)''')

c.execute(''' CREATE TABLE IF NOT EXISTS Bus88( Busnumber integer, Source Text, Destination Text, Departuretime Text, Arrivaltime Text,  Busname Text )''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail99( BusNumber real,Name Text, Gender Text, Age real,Type Text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail8( BusNumber integer, Source Text, Destination Text,Departuretime Text,Arrival Text,Busname Text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail7( BusNumber real,Name Text, Gender Text, Age real,Type Text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail6( BusNumber real, Source Text, Destination Text,Departuretime Text,Arrival Text,Busname Text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail111( BusNumber real, Source Text, Destination Text,Departuretime Text,Arrival Text,Busname Text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail11( BusNumber real, Source Text, Destination Text,Departuretime Text,Arrival Text,Busname Text, Type text)''')

#c.execute(''' CREATE TABLE IF NOT EXISTS Rail( Name Text, Gender Text, Age Text)''')


insert_qry=''' INSERT INTO Bus88(Busnumber,  Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12235, 'Coimbatore', 'Trichy', '14:30', '7:55', 'Greenline Travels' )'''

insert_qry1=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12236, 'Coimbatore', 'Trichy', '16:30', '5:50', 'Asian Xpress'  )'''

insert_qry2=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12237, 'Coimbatore', 'Trichy', '8:35', '15:50',  'Parveen Travels' )'''

insert_qry3=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12238, 'Coimbatore', 'Trichy', '12:30', '7:20', 'Vignesh TAT' )'''

insert_qry4=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12239, 'Coimbatore', 'Madurai', '6:30', '18:20', 'KPN Travels' )'''

insert_qry5=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12240, 'Coimbatore', 'Madurai', '14:30', '23:30', 'RKT Travels' )'''

insert_qry6=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12241, 'Coimbatore', 'Madurai', '12:30', '8:40', 'Iravat Travels' )'''

insert_qry7=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12242, 'Coimbatore', 'Madurai', '8:30', '16:20', 'Orange Travels'  )'''

insert_qry8=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12243, 'Chennai', 'Madurai', '9:30', '14:40', 'MMT Travels' )'''

insert_qry9=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12244, 'Chennai', 'Madurai', '1:00', '00:45', 'AGB Travels' )'''

insert_qry10=''' INSERT INTO Bus88(Busnumber,Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12245, 'Chennai', 'Madurai', '11:05', '3:00', 'ASR Travels' )'''

insert_qry11=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12246, 'Chennai', 'Madurai', '14:05', '6:45', 'RIR Travels' )'''

insert_qry12=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12247, 'Chennai', 'Trichy', '1:40', '10:40', 'APR Travels' )'''

insert_qry13=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12248, 'Chennai', 'Trichy', '6:30', '10:45', 'YBM Travels' )'''

insert_qry14=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12249, 'Chennai', 'Trichy', '11:05', '20:00', 'National Travels' )'''

insert_qry15=''' INSERT INTO Bus88(Busnumber, Source , Destination ,Departuretime ,Arrivaltime, Busname ) VALUES(12250, 'Chennai', 'Trichy', '12:10', '21:10', 'Sharma Travels'  )'''
...
global DepartureTime, Busnumber, Number
#root = Tk()
...
class main_window:
    def __init__(self,root):
        self.root=root
        self.root.title("BUS RESERVATIONS")
        ...
        Label(self.root, text="MNP TRAVELS",font=('Slab Serif',17),bg='Orange').place(x=100,y=150)
    ...
    def createWindow(self):
        ...
        classes = ['AC','NON AC','AC SLEEPER', 'NON AC SLEEPER']
        ...
        Button(self.window,text="Search buses",font=('Slab Serif',15), bg="green",fg="white",command=self.Check).place(x=80,y=250,width=120)
    ...
    def Check(self):
            if len(self.entry1.get()) == 0 or len(self.entry2.get()) == 0 or len(self.entry3.get()) == 0:
                ...
                self.Checks()
    def Checks(self):
            if (self.entry1.get() == "Chennai" and self.entry2.get() == "Madurai" and self.entry3.get() == "AC SLEEPER") or (self.entry1.get() == "Chennai" and self.entry2.get() == "Trichy" and self.entry3.get() == "AC SLEEPER"):
                tkinter.messagebox.showinfo('Error','Sorry Bus Unavailable!')
            else:
                self.Search()
    ...
    def Search(self):
        ...
        #self.root.destroy()   
        self.window1=Tk()
        self.window1.title("BUS SCHEDULE")
        ...
        for i in range(height):  # Rows
            for j in range(width):  # Columns
                ...
                self.e1.insert(10, "Bus number")
                self.e2.insert(10, "Bus name")
                self.e3.insert(10, "Source")
                self.e4.insert(10, "Departure time")
                self.e5.insert(10, "Destination")
                self.e6.insert(10, "Arrival")
                self.e7.insert(10, "Type")
                
           
            
            if self.variable.get() == "Coimbatore" and self.variable1.get()== "Trichy":
                    self.en8.insert(10, "12235")

                    self.e9.insert(10, "Greenline Travels")
                    self.e10.insert(10, "Coimbatore")
                    self.e11.insert(10, "14:30")
                    self.e12.insert(10, "Trichy")
                    self.e13.insert(10, "7:55")
                    self.e14.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en15.insert(10, "12236")

                    self.e16.insert(10, "Asian Xpress")
                    self.e17.insert(10, "Coimbatore")
                    self.e18.insert(10, "16:30")
                    self.e19.insert(10, "TRichy")
                    self.e20.insert(10, "5:50")
                    self.e21.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en22.insert(10, "12237")
                    self.e23.insert(10, "Parveen Travels")
                    self.e24.insert(10, "Coimbatore")
                    self.e25.insert(10, "8:35")
                    self.e26.insert(10, "Trichy")
                    self.e27.insert(10, "15:50")
                    self.e28.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en29.insert(10, "12238")
                    self.e30.insert(10, "Vignesh TAT")
                    self.e31.insert(10, "Coimbatore")
                    self.e32.insert(10, "12:30")
                    self.e33.insert(10, "Trichy")
                    self.e34.insert(10, "7:20")
                    self.e35.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")


            if self.variable.get() == "Coimbatore" and self.variable1.get()== "Madurai":
                    self.en8.insert(10, "12239")

                    self.e9.insert(10, "KPN Travels")
                    self.e10.insert(10, "Coimbatore")
                    self.e11.insert(10, "6:30")
                    self.e12.insert(10, "MAdurai")
                    self.e13.insert(10, "18:20")
                    self.e14.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en15.insert(10, "12240")
                    self.e16.insert(10, "RKT Travels")
                    self.e17.insert(10, "Coimbatore")
                    self.e18.insert(10, "14:30")
                    self.e19.insert(10, "MAdurai")
                    self.e20.insert(10, "23:30")
                    self.e21.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en22.insert(10, "12241")
                    self.e23.insert(10, "Iravat Travels")
                    self.e24.insert(10, "Coimbatore")
                    self.e25.insert(10, "12:30")
                    self.e26.insert(10, "MAdurai")
                    self.e27.insert(10, "8:40")
                    self.e28.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

                    self.en29.insert(10, "12242")
                    self.e30.insert(10, "Otange Travels")
                    self.e31.insert(10, "Coimbatore")
                    self.e32.insert(10, "8:30")
                    self.e33.insert(10, "MAdurai")
                    self.e34.insert(10, "16:20")
                    self.e35.insert(10, "AC, NON AC, AC SLEEPER, NON AC SLEEPER")

            if self.variable.get() == "Chennai" and self.variable1.get()== "Madurai":
                    self.en8.insert(10, "12243")
                    self.e9.insert(10, "MMT Travels")
                    self.e10.insert(10, "Chennai")
                    self.e11.insert(10, "9:30")
                    self.e12.insert(10, "MAdurai")
                    self.e13.insert(10, "14:40")
                    self.e14.insert(10, "AC, NON AC, NON AC SLEEPER")

                    self.en15.insert(10, "12244")
                    self.e16.insert(10, "AGB Travels")
                    self.e17.insert(10, "Chennai")
                    self.e18.insert(10, "1:00")
                    self.e19.insert(10, "Madurai")
                    self.e20.insert(10, "00:45")
                    self.e21.insert(10, "AC, NON AC, NON AC SLEEPER")

                    self.en22.insert(10, "12245")
                    self.e23.insert(10, "ASR Travels")
                    self.e24.insert(10, "Chennai")
                    self.self.e25.insert(10, "11:05")
                    self.e26.insert(10, "Madurai")
                    self.e27.insert(10, "3:00")
                    self.e28.insert(10, "AC, NON AC, NON AC SLEEPER")

                    self.en29.insert(10, "12246")
                    self.e30.insert(10, "RIR TRavels")
                    self.self.e31.insert(10, "Chennai")
                    self.e32.insert(10, "14:05")
                    self.e33.insert(10, "Madurai")
                    self.e34.insert(10, "6:45")
                    self.e35.insert(10, "AC, NON AC, NON AC SLEEPER")

            if self.variable.get() == "Chennai" and self.variable1.get()== "Trichy":
                    self.en8.insert(10, "12247")
                    #and12247=12247
                    self.e9.insert(10, "APR Travels")
                    self.e10.insert(10, "Chennai")
                    ...
                    self.e16.insert(10, "YBM Travels")
                    self.e17.insert(10, "Chennai")
                    ...
                    self.e23.insert(10, "National Travels ")
                    self.e24.insert(10, "Chennai")
                    ...
                    self.e30.insert(10, "Sharma Travels")
    ...
    def PassengerDetails1(self):
        ...
        for i in range(height):  # Rows
            for j in range(width):  # Columns
                ...
                proof = {'Aadhar card', 'Driving License'}
                self.v6.set('Select')
    ...
    def Show1(self):
        ...
        Label(self.window3, text="Type",bg='white', font=('Slab Serif', 11)).place(x=320, y=130)
        Label(self.window3, text="Bus no.",bg='white',font=('Slab Serif', 11)).place(x=90, y=130)
        Label(self.window3, text="Bus name",bg='white', font=('Slab Serif', 11)).place(x=90, y=170)
        ...
        self.Busnumber = Label(self.window3, justify="center",bg='white', font=('Slab Serif', 10))
        self.Busnumber.place(x=170, y=130, height=25)


        global conn, cursor, x1, x2
        if x1 == 12235:
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12235")
            ...
            for data in fetch:
                ...
                self.Busname = Label(self.window3, text=data[5],bg='white', justify="center",
            ...
            cursor.execute("Insert into Bus999 (pnr,Name,Gender,Age) values (?,?,?,?)",
                                (pnr, str(self.enn7.get()),int(self.enn8.get()), str(self.enn9.get())))

            conn.commit()


            cursor.execute("Select * from Bus999 where pnr=?  ",(pnr,))
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12239")
            fetch = cursor.fetchall()
            for data in fetch:
                ...
                self.Destination = Label(self.window3, text=data[2], justify="center",bg='white',
                                        font=('Slab Serif', 10)).place(x=170, y=250, height=25)
                self.Busname = Label(self.window3, text=data[5], justify="center",bg='white',
                                            font=('Slab Serif', 10)).place(x=170, y=210, height=25)
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12243")
            fetch = cursor.fetchall()
            for data in fetch:
                ...
                self.Destination = Label(self.window3, text=data[2],bg='white', justify="center",
                                            font=('Slab Serif', 10)).place(x=170, y=250, height=25)
                self.Busname = Label(self.window3, text=data[1],bg='white', justify="center",
                                            font=('Slab Serif', 10)).place(x=170, y=210, height=25)
                self.DepartureTime = Label(self.window3, text=data[3], justify="center",bg='white',
                                                font=('Slab Serif', 10)).place(x=170, y=90, height=25)
            a = 111111
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12247")
            fetch = cursor.fetchall()
            for data in fetch:
                ...
                self.Destination = Label(self.window3, text=data[2], justify="center",bg='white',
                                        font=('Slab Serif', 10)).place(x=170, y=250, height=25)
                self.Busname = Label(self.window3, text=data[1], justify="center",bg='white',
                                            font=('Slab Serif', 10)).place(x=170, y=210, height=25)
                self.DepartureTime = Label(self.window3, text=data[3], justify="center",bg='white',
                                                font=('Slab Serif', 10)).place(x=170, y=90, height=25)
            a = 111111
    ...
    def Show2(self):
        ...
        if x1 == 12236:
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12236")
            fetch = cursor.fetchall()
            for data in fetch:
                ...
                self.Destination = Label(self.window3, text=data[2], justify="center",
                                        font=('Slab Serif', 10)).place(x=170, y=250, height=25)
                self.Busname = Label(self.window3, text=data[1], justify="center",
                                        font=('Slab Serif', 10)).place(x=170, y=210, height=25)
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12240")
            fetch = cursor.fetchall()
            for data in fetch:
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12244")
            fetch = cursor.fetchall()
            for data in fetch:
                self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 10)).place(
                            x=170, y=170, height=25)
            ...
            cursor = conn.cursor()
            self.Busnumber.config(text=x1)
            cursor.execute("Select * from Bus88 where Busnumber=12248")
            fetch = cursor.fetchall()
            for data in fetch:
                self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 10)).place(
                        x=170, y=170,height=25)
    ...
    def Check3(self):
        ...
        def Show3(self):
            ...
            if x1 == 12237:                        
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12237")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 10)).place(
                        x=170, y=170, height=25)
                ...
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12241")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 9)).place(
                        x=170, y=170, height=25)
                ...
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12245")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 10)).place(
                        x=170, y=170, height=25)
                ...
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12249")
                fetch = cursor.fetchall()
                for data in fetch:
    ...
    def PassengerDetails4(self):
        ...
        def Show4(self):
            ...
            if x1 == 12238:
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12238")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 10)).place(
                        x=170, y=170, height=25)
                ...
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12242")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5],bg='white', justify="center", font=('Slab Serif', 9)).place(
                        x=170, y=170, height=25)
                ...
                cursor = conn.cursor()
                Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12246")
                fetch = cursor.fetchall()
                for data in fetch:
                    ...
                    Destination = Label(self.window3, text=data[2],bg='white', justify="center",
                                        font=('Slab Serif', 10)).place(x=170, y=250, height=25)
                    Busname = Label(self.window3, text=data[1],bg='white', justify="center",
                                        font=('Slab Serif', 10)).place(x=170, y=210, height=25)
                ...
                cursor = conn.cursor()
                self.Busnumber.config(text=x1)
                cursor.execute("Select * from Bus88 where Busnumber=12250")
                fetch = cursor.fetchall()
                for data in fetch:
                    self.Source = Label(self.window3, text=data[5], bg='white',justify="center", font=('Slab Serif', 10)).place(x=170, y=170,height=25)
                    self.Destination = Label(self.window3, text=data[2],bg='white', justify="center",
    ...
    def Delete1(self):
        ...
        if self.result == 'yes':
            cursor = conn.cursor()
            cursor.execute("Select pnr from Bus999")
            d = cursor.fetchall()
            ...
            for i in range(1,len(d6)):
                if self.e.get()==d6[i]:
                    ...
                    q=1
            if q==1:
                cursor.execute("Delete from Bus999 where pnr=?",(x123,))
